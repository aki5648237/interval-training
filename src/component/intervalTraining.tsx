...
export const IntervalTraining = () => {
  ...
  return (
    <Box className="container">
     <AppHeader />
     <Typography variant="h2" sx={{ textAlign: 'center', marginTop: '50px', marginBottom: '10px', fontWeight: 'bold', color: '#F4538A'}}>インターバルクイズ</Typography>
      <Card sx={{margin: '0 20px 50px 20px', height: '130px'}} variant="outlined">  
